...
stockData, stockMarketData = get_historical_stock_price(stock)

#data = pd.read_csv('data_stocks.csv')

data = pd.DataFrame()
#stockData['Open'] = stockData['Open'][1:]
#Xtest = stockMarketData['Close'][-1]

# Drop date variable
data['Close'] =  stockData['Close']
data['S&P'] =  stockMarketData['Close']
